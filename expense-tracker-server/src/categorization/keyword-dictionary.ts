export const KEYWORDS = {
    food: [
        ...
        'tiffin', 'thali', 'samosa', 'dosa', 'idli', 'subway', 'mcdonald',
    ],
    ...
    travel: [
        ...
        'visa', 'boarding', 'luggage', 'cab fare', 'parking pass', 'airport',
        'station', 'ride',
    ],
    ...
    medicine: [
        ...
        'doctor fee', 'consultation', 'scan', 'xray', 'lab', 'cough syrup',
        'checkup', 'fever', 'injury', 'vet', 'veterinary',
    ],
    ...
    entertainment: [
        ...
        'pvr', 'inox', 'cinepolis', 'subscription',
    ],
